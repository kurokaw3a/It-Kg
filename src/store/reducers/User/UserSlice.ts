...
const initialState: userState = {
  ...
  news: [
    ...
    },
    {
      ...
      title: 'Заголовок',
      description:
          'Title — это передовая компанияпередовая компания, занимающаяся разработкой инновационных технологий в области нефтегазовой промышленности. С фокусом на устойчивом развитии и экологической ответственности, Neftchi ищет новые пути для улучшения процессов добычи, переработки и использования энергии. Используя передовые научные методы и инженерные решения, Neftchi стремится сократить вредные выбросы и оптимизировать производственные процессы,',
    },
  ],
  newsPage: {
    id: 1,
    title: 'Заголовок',
    description:
        'Title — это передовая компания, занимающаяся разработкой инновационных технологий в области нефтегазовой промышленности. С фокусом на устойчивом развитии и экологической ответственности, Neftchi ищет новые пути для улучшения процессов добычи, переработки и использования энергии.',
    date: '13.02.2022',
    category: 'important',
  ...
  faq: [
    ...
    },
    {
      ...
      title: 'Вопрос',
      description:
          'Ответ ответответ ответответответответ ответ ответответответ ответответ ответ',
    },
  ],
  administration: [
    {
  ...
  documents: [
    ...
    {
      id: 2,
      title: 'НазваниеНазваниеНазваниеНазваниеНазваниеНазвание',
      description: 'Описание',
      file: 'pdf',
    },
    {
