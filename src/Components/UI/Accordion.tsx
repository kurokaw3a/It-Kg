...
const Accordion: FC<AccordionProps> = ({ items }) => {
    ...
    return (
        <div className='flex flex-col gap-[10px] text-black md:p-0 pl-[15px] pr-[15px]'>
            {items.map((el: IAccordion, i: number) => (
                <div key={el.id}>
                    <div
                        className='flex items-center bg-[#0057E10D] md:w-[900px] select-none cursor-pointer'
                    ...
                    >
                        ...
                        <div className='md:w-[750px] w-[350px] md:pl-[36px] pl-[20px] pr-[20px] flex items-center justify-between'>
                            <p className='md:text-[22px] text-[18px] font-[400] font-[Oswald]'>
                                {el.title}
                            </p>
                    ...
                    <div
                        className={`bg-[#0057E126] rounded-b-[11px] max-w-[900px] grid overflow-hidden transition-all duration-300 ease-in-out ${
                            i === active
